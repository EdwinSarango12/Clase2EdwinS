...
public class Main {
    public static void main(String[] args) {
        ...
        Cancion miCancion= new Cancion("","","3:30");
        miCancion.setNombre(titulo);
        ...
        Series miSerie = new Series("","","Terror");
        miSerie.setName(name);
        miSerie.setDescription(description);
        miSerie.imprimirSeries();*/
        ...
        Pelicula miPelicula= new Pelicula("","Terror");
        miPelicula.setTituloPelicula(titulo);
        ...
        Persona miPersona = new Persona("",0,68.8);
